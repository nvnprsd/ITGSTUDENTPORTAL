...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
   <div id="block" style="margin-left:20px; margin-top:30px; width:80%">
         <asp:RadioButton ID="student" runat="server" BorderStyle="None" GroupName="Sel" Text="Student" OnCheckedChanged="student_CheckedChanged" />
        <asp:RadioButton ID="faculty" runat="server" BorderStyle="None" GroupName="Sel" Text="Faculty" OnCheckedChanged="faculty_CheckedChanged" />
  ...
  <asp:TextBox ID="serial" placeholder="Enter Serial Number of book" runat="server" BorderStyle="None" required></asp:TextBox>
        ...
        <div><asp:DropDownList ID="Year" runat="server" Height="25px" Width="109px">
